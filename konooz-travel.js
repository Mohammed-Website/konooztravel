...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+966570350011?text=طلب%20حجز%20هذا%20العرض:%0Ahttps://mohammed-website.github.io/konooztravel/${encodeURIComponent(src)}`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+966570350011";
